...
card.querySelector('.service-card-link').addEventListener('click', (e) => {
    e.preventDefault();
    alert(`Redirecting to ${service.title} page... (link this to actual page)`);
});
    ...
    // ✅ Populate Testimonials (Fix applied here)
...
document.querySelectorAll('.book-btn').forEach(btn => {
  ...
  document.getElementById('appointmentForm').addEventListener('submit', function(e) {
    ...
    function redirectToResultsPage(location) {
        modal.style.display = "none";
        window.location.href = `blood-results.html?location=${encodeURIComponent(location)}`;
    }
